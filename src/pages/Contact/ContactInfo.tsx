			...
			<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
				...
				>
					<div>
						...
						<p className="mt-4 text-sm md:text-base text-gray-500 dark:text-gray-400 leading-relaxed max-w-2xl">
                ...
                "
					...
					{/* Bottom Row */}
					<div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 p-4 rounded-2xl bg-[#3CC4C9]/10 border border-[#3CC4C9]/20">
						<div>
						...
						<Link
							to="/booking"
							className="
                shrink-0 px-8 py-3.5 rounded-full text-sm font-semibold
