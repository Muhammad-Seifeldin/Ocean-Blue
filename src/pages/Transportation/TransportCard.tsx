			...
			<div className="p-5 flex flex-col flex-1">
				...
				<div className="flex flex-col gap-4 flex-1">
					<div className="flex flex-col gap-1.5">
						...
						<p className="text-sm text-gray-500 dark:text-gray-400 leading-relaxed h-16 overflow-hidden">
							{option.description}
						</p>
					</div>

					{/* Highlights */}
					<ul className="flex flex-col gap-2 h-28">
				...
				{/* Included */}
				<div className="flex flex-col gap-3 pt-4 mt-4 border-t border-gray-100 dark:border-[#0A4D68]/30 h-50">
					<div>
